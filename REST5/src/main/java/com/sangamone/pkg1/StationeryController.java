...
public class StationeryController {
	...
	public ArrayList<String> genReport3() {
		...
		list1.add(s1+getLocationById(1)+getLocationById(2)+" : "+String.valueOf(total3));
		return list1;
	}
	...
	public String getLocationById(@PathVariable int id ) {
		return sr.getDistinctLocations().get(id-1);
		
	}

	@GetMapping("/sale/report4")
	public int getReport4(){
		int totalamt=sr.getSalesAmt3();
		return totalamt;
	}
	

	@GetMapping("/sale/report5")
	public int getReport5(){
		int totalamt = sr.getSalesAmt4();
		return totalamt;
	} 
